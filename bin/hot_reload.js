...
addOptions(program.command('watch <localRoot>').description('watch a js project root'))
    ...
    const scriptSourcesMgr = new ScriptSourcesMgr_1.ScriptSourcesMgr({ trace: opts.verbose, localRoot: path.resolve(localRoot), remoteRoot: opts.remoteRoot, forceCJS: opts.forceCJS });
